...
extern "C" MFORMATS_API void log_set_callback(void (*fn) (ELogSeverity severity, const char *message, void *_private), void *param);
extern "C" MFORMATS_API void * create_worker(const char *type);
extern "C" MFORMATS_API bool destroy_worker(void *w);
extern "C" MFORMATS_API void set_workflow(void *w, const SWorkflowPad &wp);
extern "C" MFORMATS_API bool load_worker(void *w, const char *param);
